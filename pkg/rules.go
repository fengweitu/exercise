...
func SetRules(s Netlink, content []byte) (warnings []string, err error) {
	...
	fmt.Println("len audit rules: ",len(rules.AuditRules))
	for _, x := range rules.AuditRules {
		// Convert JSON rule to a kernel rule
		fmt.Println("x auditRule: ",x)
		...
		fmt.Printf("kr:%v\n",kr)
		fmt.Println("-------------------------------------------------------------")
		fmt.Println("Flags: ",kr.Flags)
		fmt.Println("Action: ",kr.Action)
		fmt.Println("FieldCount: ",kr.FieldCount)
		fmt.Println("Mask: ",kr.Mask)
		fmt.Println("Fields: ",kr.Fields)
		fmt.Println("Values: ",kr.Values)
		fmt.Println("Fieldflags: ",kr.Fieldflags)
		fmt.Println("Buflen: ",kr.Buflen)
		fmt.Println("Buf: ",kr.Buf)
		...
		//fmt.Println("Flags: ",string(kr.Flags))
		//fmt.Println("Action: ",kr.Action)
		//fmt.Println("FieldCount: ",kr.FieldCount)
		//fmt.Println("Mask: ",kr.Mask)
		//fmt.Println("Fields: ",kr.Fields)
